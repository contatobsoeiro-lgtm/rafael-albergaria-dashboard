...
VENDORS_DISPLAY_ORDER = ["RAFAEL", "SUPORTE", "OUTROS"]

# Junio, Duda e Raquel sairam da equipe (jul/2026); Bia nao atua como
# vendedora. O historico deles aparece unificado no dashboard como "OUTROS"
VENDORS_QUE_SAIRAM = {"JUNIO", "DUDA", "RAQUEL", "BIA"}
...
def normalize_df(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df["vendedor"]   = df["vendedor"].map(lambda v: "OUTROS" if v in VENDORS_QUE_SAIRAM else v)
